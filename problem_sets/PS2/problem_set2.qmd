...
*R stores dates as the number of days since Jan 1, 1970. The double is the digit, and the class is how R presents the object, as a date*
...
abbr_today <- wday(today, label = TRUE)
abbr_today
```
...
*https://github.com/nilsonpalma/PHW251.git*
